    ...
    <section className="space-y-5">
      <div>
        ...
        <p className="mt-1 text-sm text-muted">
          Incoming requests for your fleet. Confirm, reject, start, or complete trips.
        </p>
      </div>
      {loadError ? (
        ...
        <BookingList
          bookings={bookings}
          hrefFor={(id) => `/vendor/bookings/${id}`}
          emptyDescription="When customers request your vehicles, those jobs will appear here."
        />
      )}
    </section>
  );
